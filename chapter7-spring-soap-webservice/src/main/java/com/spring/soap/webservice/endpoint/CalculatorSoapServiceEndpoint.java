...
import com.spring.soap.webservice.application.generated.KodluyoruzModInput;
import com.spring.soap.webservice.application.generated.KodluyoruzModOutput;
...
public class CalculatorSoapServiceEndpoint {
	...
	@ResponsePayload
	@PayloadRoot(namespace = NAMESPACE_URI, localPart = "KodluyoruzModInput")
	public KodluyoruzModOutput kodluyoruzModOperation(
			@RequestPayload KodluyoruzModInput modKodluyoruzModInput) {
		
		ObjectFactory objectFactory = new ObjectFactory();
		
		long result = modKodluyoruzModInput.getA() % modKodluyoruzModInput.getB();
		
		KodluyoruzModOutput output = objectFactory.createKodluyoruzModOutput();
		output.setModResult(result);
